  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>B STORE</h2></a>
            ...
            <li class="nav-item active">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a style="color:greenyellow" href="{{url('dashboard')}}">PRODUCT</a></li>
                  <li><a style="color:greenyellow" href="{{url('dashboard')}}">USER</a></li>
                </ul>
              </div>
              </li>
